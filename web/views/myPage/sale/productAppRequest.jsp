		...
		<ul class="flowList-col2">
			<li>
				<div class="txtAtg vrea">
					<p class="stepArea"><img src="../../../img/step1.png" width="60" height="60" alt="STEP01"></p>
					
					<p class="titArea">출품 예정인 상품을 촬영합니다.</p>
					<p class="exArea">출품하고 싶으신 시계의 사진을 찍어주세요. 앞면, 뒷면 등등 여러 각도에서 사진을 찍어 주세요</p>
				</div>
				<div class="imgArea" style="width:350px;"><!-- <img src="../../img/quick_pca2_ph1.jpg" width="350" height="350" alt="출품 예정인 상품을 촬영합니다."> --></div>
			</li>
			<li>
				<div class="txtArea">
					<p class="stepArea"><img src="../../../img/step2.png" width="60" height="60" alt="STEP02"></p>
...
-->
			...
			<li>
				<div class="txtArea">
					<p class="stepArea"><img src="../../../img/step3.png" width="60" height="60" alt="STEP03"></p>
				 ...
				 <div class="imgArea" style="width:350px;"><!-- <img src="/image/tp2/users-guide/sell/en/sell_my_luxury_watch_640.jpg" width="350" height="350" class="bLine" alt=" [상품 정보 입력하기]를 클릭해 제품 정보를 입력해주세요."> --></div>
			</li>
			<li>
				<div class="txtArea">
					<p class="stepArea"><img src="../../../img/step4.png" width="60" height="60" alt="STEP04"></p>
					<p class="titArea">미리 보기</p>
					<p class="exArea">
					[저장]을 클릭 후, 미리보기를 확인하여 틀린 정보나 잘못된 정보가 없는지 마지막으로 확인해 주세요.					등록된 정보가 확실한지 다시 한번 더 확인해주세요.					</p>
				</div>
				<div class="imgArea" style="width:350px;"><!-- <img src="/image/tp2/users-guide/sell/en/confirm_preview_640.jpg" width="350" height="350" class="bLine" alt="미리 보기"> --></div>
			</li>
			<li>
				<div class="txtArea">
					<p class="stepArea" ><img src="../../../img/step5.png" width="60" height="60" alt="STEP05"></p>
				...
				<div class="imgArea" style="width:350px;"><!-- <img src="/image/tp2/users-guide/sell/en/start_selling_640.jpg" width="350" height="350" class="bLine" alt="판매개시를 하면 출품작업은 완료됩니다."> --></div>
